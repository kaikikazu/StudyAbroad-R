...
f_html = open('HTML/index2.html','wb')
f_top = open('Text/head.txt','r',encoding="utf-8_sig")
f_sectionstart = open('Text/sectionstart.txt','r',encoding="utf-8_sig")
f_sectionend = open('Text/sectionend.txt','r',encoding="utf-8_sig")
...
for tweet in data:
    ...
    if len(tweet["entities"]) == 5:
            ...
            TEXT = TEXT + "<img class=\"img-fluid\" src=\"" + "\" alt=\"\">"
    TEXT + TEXT + StringEnd
